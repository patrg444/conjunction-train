#!/usr/bin/env python3
"""
Create a local copy of the script with the comma fix.
This version includes the necessary commas in the set_value calls.
"""
...
def load_wav2vec_data(dataset_path, max_samples=None):
    ...
    for npz_file in npz_files:
        try:
            ...
            label = data['emotion'].item()  # Access the scalar value
