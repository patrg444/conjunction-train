...
# Generated specifically for run started around: 20250329_055056
...
LOG_FILE="training_audio_pooling_lstm_20250329_055056.log" # Specific log file for this run
REMOTE_DIR="/home/ec2-user/emotion_training"
PID_FILE="audio_pooling_lstm_20250329_055056_pid.txt" # Specific PID file for this run
MONITORING_INTERVAL=30

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING AUDIO POOLING LSTM MODEL TRAINING (20250329_055056)    ${NC}"
echo -e "${BLUE}==================================================================${NC}"
