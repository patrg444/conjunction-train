...
print("IMPROVED TRAINING SCRIPT WITH DYNAMIC PADDING STARTING - NO DATA LEAKAGE")
...
def create_enhanced_model_with_masking(audio_feature_dim, video_feature_dim):
    ...
    print("- Audio feature dimension: {}".format(audio_feature_dim))
    print("- Video feature dimension: {}".format(video_feature_dim))
...
def train_model():
    ...
    print("Starting enhanced model training with DYNAMIC SEQUENCE PADDING (NO DATA LEAKAGE)...")
    ...
    if ravdess_audio is not None:
        ...
        print("Added RAVDESS: {} samples".format(len(ravdess_audio)))
    ...
    if cremad_audio is not None:
        ...
        print("Added CREMA-D: {} samples".format(len(cremad_audio)))
    
    print("Combined: {} total samples".format(len(all_audio)))
    
    # SKIP DATA AUGMENTATION - key change from original script
    print("Skipping data augmentation...")
    
    print("Dataset size (no augmentation):")
    print("- Number of samples: {}".format(len(all_audio)))
    ...
    print("- Train samples: {}".format(len(train_audio)))
    print("- Validation samples: {}".format(len(val_audio)))
    ...
    print("Using class weights to handle imbalance: {}".format(class_weights))
    
    # Train the model
    print("Starting training with dynamic sequence padding (no data leakage)...")
    ...
    print("- Best validation accuracy: {}".format(max(history.history['val_accuracy'])))
    print("- Best validation loss: {}".format(min(history.history['val_loss'])))
