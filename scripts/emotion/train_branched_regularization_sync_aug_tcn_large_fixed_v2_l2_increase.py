...
VARIANT: Increased L2 Regularization
"""
...
L2_REGULARIZATION = 0.0025 # VARIANT: Increased from 0.002 back towards original 0.0025
MAX_NORM_CONSTRAINT = 3.0  # Weight constraint value
LEARNING_RATE = 0.0006     # Base learning rate
...
print("VARIANT: Increased L2 Regularization to 0.0025")
...
def train_model():
    ...
    print(f"- Using L2 regularization: {L2_REGULARIZATION}") # Added print for L2
    ...
    checkpoint = ModelCheckpoint(
        'best_model_tcn_large_fixed_v2_l2_increase.keras', # Adjusted checkpoint name
    ...
    model.load_weights('best_model_tcn_large_fixed_v2_l2_increase.keras') # Adjusted checkpoint name
