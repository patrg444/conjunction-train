...
print("IMPROVED TRAINING SCRIPT WITH DYNAMIC PADDING STARTING")
...
def train_model():
    ...
    print("Starting enhanced model training with DYNAMIC SEQUENCE PADDING...")
    ...
    model_dir = "models/dynamic_padding"
    ...
    # Train the model
    print("Starting training with dynamic sequence padding...")
