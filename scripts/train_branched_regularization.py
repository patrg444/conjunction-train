...
Modified to add L2 regularization to dense layers for better generalization.
"""
...
L2_REGULARIZATION = 0.001  # Strength of L2 regularization

print("IMPROVED TRAINING SCRIPT WITH DYNAMIC PADDING AND L2 REGULARIZATION")
print("TensorFlow version:", tf.__version__)
print("NumPy version:", np.__version__)
print("Python version:", sys.version)

def create_enhanced_model_with_regularization(audio_feature_dim, video_feature_dim):
    """
    Create an enhanced branched model with masking layers and L2 regularization.
    ...
    """
    print("Creating enhanced branched model with masking layers and L2 regularization:")
...
def train_model():
    """Main function to train the model with dynamic padding and L2 regularization."""
    print("Starting enhanced model training with DYNAMIC SEQUENCE PADDING AND L2 REGULARIZATION...")
    ...
    # Create and compile the enhanced model with regularization
    model = create_enhanced_model_with_regularization(audio_feature_dim, video_feature_dim)
    model.summary()
    
    # Create output directories if they don't exist
    model_dir = "models/branched_regularization"
    ...
    # Train the model
    print("Starting training with dynamic sequence padding and L2 regularization...")
