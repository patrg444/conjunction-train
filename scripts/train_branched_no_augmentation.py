...
Version without data augmentation to test for data leakage.
"""
...
print("IMPROVED TRAINING SCRIPT WITH DYNAMIC PADDING STARTING - NO AUGMENTATION")
...
def normalize_features(features_list):
    ...
    """
    # First, calculate global mean and std across all sequences
    # We need to concatenate all features
    ...
    # Normalize each sequence individually using the global stats
    normalized_list = []
...
def train_model():
    ...
    print("Starting enhanced model training with DYNAMIC SEQUENCE PADDING (NO AUGMENTATION)...")
    ...
    print("Skipping data augmentation to test for data leakage...")
    ...
    all_audio = normalize_features(all_audio)
    ...
    model_dir = "models/dynamic_padding_no_aug"
    ...
    # Train the model
    print("Starting training with dynamic sequence padding (no augmentation)...")
