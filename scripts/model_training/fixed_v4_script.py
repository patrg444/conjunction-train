...
class WarmUpReduceLROnPlateau(Callback):
    ...
    def on_epoch_begin(self, epoch, logs=None):
        ...
        if epoch < self.warmup_epochs:
            ...
            if self.verbose > 0:
                print(f'\nEpoch {epoch+1}: WarmUpReduceLROnPlateau setting learning rate to {learning_rate.numpy()}.') # Use .numpy() for printing
        ...
        if self.monitor_op(current, self.best):
            ...
            if self.wait >= self.patience:
                ...
                if old_lr > self.min_lr:
                    ...
                    if self.verbose > 0:
                        print(f'\nEpoch {epoch+1}: WarmUpReduceLROnPlateau reducing learning rate to {new_lr.numpy()}.') # Use .numpy() for printing
...
def train_model(args):
    ...
    if model_name is None:
        ...
        model_name = f"wav2vec_audio_only_fixed_v4_{timestamp}"
