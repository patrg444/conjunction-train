#!/bin/bash
# Script to run the smooth camera demo with moving average

# Display header
echo "Smooth Camera Demo for Emotion Recognition"
echo "=============================================="
echo ""
...
display_width=800
display_height=600
window_size=30  # Longer smoothing window for more stable results
...
echo "Starting smooth camera demo with moving average..."
echo "Press q or ESC to quit"
echo ""

$python_cmd scripts/smooth_camera_demo.py \
    --fps "$fps" \
