...
def train_model(model, train_data, val_data, model_dir='models/branched_6class',
...
def evaluate_model(model, test_data, class_names=None, output_dir='model_evaluation/branched_6class'):
...
def main():
    ...
    # If max sequence lengths are specified, use them instead of the global maximums
    ...
    logging.info(f"Using maximum video length: {max_video_length}")
    logging.info(f"Using maximum audio length: {max_audio_length}")
