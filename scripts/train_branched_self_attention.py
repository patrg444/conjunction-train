...
Modified to add self-attention layers to both audio and video branches.
"""
...
print("IMPROVED TRAINING SCRIPT WITH DYNAMIC PADDING AND SELF-ATTENTION")
...
def create_enhanced_model_with_attention(audio_feature_dim, video_feature_dim):
    """
    Create an enhanced branched model with masking layers and self-attention.
    ...
    """
    print("Creating enhanced branched model with masking and self-attention:")
    ...
    # Add self-attention layer after the LSTM to capture important audio features
    audio_attention = AttentionLayer()(audio_x)
    audio_x = Dense(128, activation='relu')(audio_attention)
    ...
    # Add self-attention layer after the LSTM to capture important video features
    video_attention = AttentionLayer()(video_x)
    video_x = Dense(256, activation='relu')(video_attention)
...
def train_model():
    """Main function to train the model with dynamic padding and self-attention."""
    print("Starting enhanced model training with DYNAMIC SEQUENCE PADDING AND SELF-ATTENTION...")
    ...
    # Create and compile the enhanced model with attention layers
    model = create_enhanced_model_with_attention(audio_feature_dim, video_feature_dim)
    model.summary()
    
    # Create output directories if they don't exist
    model_dir = "models/branched_self_attention"
    ...
    # Train the model
    print("Starting training with dynamic sequence padding and self-attention...")
