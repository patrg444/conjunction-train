...
# Training parameters
BATCH_SIZE = 16  # Reduced from 24 for better stability
EPOCHS = 100
LEARNING_RATE = 0.001  # Increased from 0.0005
PATIENCE = 15
TRAIN_RATIO = 0.8
L2_REGULARIZATION = 0.001  # Reduced from 0.002
MAX_NORM_CONSTRAINT = 2.0  # Reduced from 3.0
LSTM_UNITS = [128, 64]
DENSE_UNITS = [256, 128]
NUM_CLASSES = 6
...
# Create BiLSTM model with masking for variable length sequences
...
def train_model():
    print("IMPROVED CNN-LSTM MODEL WITH VARIABLE SEQUENCE HANDLING")
    ...
    checkpoint_dir = f"models/improved_cnn_lstm_{timestamp}"
    ...
    # Train model
    print(f"\nStarting training (improved CNN-LSTM with variable sequence handling)...")
