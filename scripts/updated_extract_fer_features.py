...
# RAVDESS videos are in Actor_* directories
RAVDESS_VIDEO_BASE_DIR = "/home/ubuntu/datasets/ravdess_videos"
# CREMA-D videos path is now known
...
CREMA_D_FER_DIR = "/home/ubuntu/emotion-recognition/crema_d_features_fer" 
...
if __name__ == "__main__":
    ...
    # Process CREMA-D videos 
    if args.dataset in ['crema_d', 'all']:
        cremad_files = glob.glob(os.path.join(CREMA_D_VIDEO_DIR, "*.mp4"))
        # Also check for .flv files as some versions of CREMA-D use this format
        cremad_files_flv = glob.glob(os.path.join(CREMA_D_VIDEO_DIR, "*.flv"))
        cremad_files.extend(cremad_files_flv)
