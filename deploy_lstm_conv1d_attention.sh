...
LOCAL_SCRIPT_PATH="scripts/train_lstm_conv1d_attention.py" # Path to the NEW training script
REMOTE_SCRIPT_NAME="train_lstm_conv1d_attention.py" # Name for the script on the EC2 instance
REMOTE_DIR="/home/ec2-user/emotion_training" # Directory on EC2 for training files
LOG_PREFIX="training_lstm_conv1d_attention" # Prefix for log files
PID_PREFIX="lstm_conv1d_attention" # Prefix for PID files
# --- End Configuration ---
...
echo -e "${BLUE}===================================================================${NC}"
echo -e "${GREEN}    DEPLOYING LSTM/CONV1D + ATTENTION MODEL SCRIPT    ${NC}" # Updated Title
echo -e "${BLUE}===================================================================${NC}"
...
echo -e "${YELLOW}Transferring LSTM/Conv1D + Attention script ($LOCAL_SCRIPT_PATH) to AWS instance...${NC}" # Updated description
...
# Transfer the generator scripts using SCP
...
echo \"Starting LSTM/Conv1D + Attention model training...\" > $REMOTE_LOG_FILE # Updated description
...
# Monitoring script for LSTM/Conv1D + Attention model training # Updated description
...
echo -e \"\${BLUE}==================================================================\${NC}\"
echo -e \"\${GREEN}    MONITORING LSTM/CONV1D + ATTENTION MODEL TRAINING (${TIMESTAMP})    \${NC}\" # Updated Title
echo -e \"\${BLUE}==================================================================\${NC}\"
