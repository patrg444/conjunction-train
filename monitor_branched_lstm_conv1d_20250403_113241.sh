...
# Generated specifically for run started around: 20250403_113241
...
REMOTE_MONITOR_HELPER="monitor_helper_branched_lstm_conv1d_20250403_113241.sh" # Name of the helper script on EC2

echo -e "\${BLUE}==================================================================\${NC}"
echo -e "\${GREEN}    MONITORING BRANCHED LSTM/Conv1D MODEL TRAINING (20250403_113241)    \${NC}"
echo -e "\${BLUE}==================================================================\${NC}"
