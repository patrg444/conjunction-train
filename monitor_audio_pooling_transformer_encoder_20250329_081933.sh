...
# Generated specifically for run started around: 20250329_081933
...
REMOTE_MONITOR_HELPER="monitor_helper_audio_pooling_transformer_encoder_20250329_081933.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING AUDIO POOLING TRANSFORMER ENCODER MODEL TRAINING (20250329_081933)    ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
