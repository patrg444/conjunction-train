#!/bin/bash
# Monitoring script for the Non-Branched LSTM/Conv1D model training
# Generated specifically for run started around: 20250328_200350
...
LOG_FILE="training_lstm_conv1d_20250328_200350.log" # Specific log file
REMOTE_DIR="/home/ec2-user/emotion_training"
PID_FILE="lstm_conv1d_20250328_200350_pid.txt" # Specific PID file
MONITORING_INTERVAL=30

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING NON-BRANCHED LSTM/Conv1D MODEL TRAINING (20250328_200350)    ${NC}"
echo -e "${BLUE}==================================================================${NC}"
