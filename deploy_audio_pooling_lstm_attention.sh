...
LOCAL_SCRIPT_PATH="scripts/train_audio_pooling_lstm_attention.py" # Path to the NEW training script
REMOTE_SCRIPT_NAME="train_audio_pooling_lstm_attention.py" # Name for the script on the EC2 instance
REMOTE_DIR="/home/ec2-user/emotion_training" # Directory on EC2 for training files
LOG_PREFIX="training_audio_pooling_lstm_attention" # Prefix for log files
PID_PREFIX="audio_pooling_lstm_attention" # Prefix for PID files
# --- End Configuration ---
...
echo -e "${BLUE}===================================================================${NC}"
echo -e "${GREEN}    DEPLOYING AUDIO POOLING LSTM + ATTENTION MODEL SCRIPT    ${NC}" # Updated Title
echo -e "${BLUE}===================================================================${NC}"
...
echo -e "${YELLOW}Transferring Audio Pooling LSTM + Attention script ($LOCAL_SCRIPT_PATH) to AWS instance...${NC}" # Updated description
...
echo \"Starting Audio Pooling LSTM + Attention model training...\" > $REMOTE_LOG_FILE # Updated description
...
# Monitoring script for Audio Pooling LSTM + Attention model training # Updated description
...
echo -e \"\${BLUE}==================================================================\${NC}\"
echo -e \"\${GREEN}    MONITORING AUDIO POOLING LSTM + ATTENTION MODEL TRAINING (${TIMESTAMP})    \${NC}\" # Updated Title
echo -e \"\${BLUE}==================================================================\${NC}\"
