...
# Generated specifically for run started around: 20250403_043415
...
REMOTE_MONITOR_HELPER="monitor_helper_audio_pooling_lstm_20250403_043415.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING AUDIO POOLING LSTM MODEL TRAINING (20250403_043415)    ${NC}"
echo -e "${BLUE}==================================================================${NC}"
