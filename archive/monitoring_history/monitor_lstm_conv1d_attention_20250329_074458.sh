...
# Generated specifically for run started around: 20250329_074458
...
REMOTE_MONITOR_HELPER="monitor_helper_lstm_conv1d_attention_20250329_074458.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING LSTM/CONV1D + ATTENTION MODEL TRAINING (20250329_074458)    ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
