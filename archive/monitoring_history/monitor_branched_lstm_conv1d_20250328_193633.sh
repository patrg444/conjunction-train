#!/bin/bash
# Monitoring script for the Branched LSTM/Conv1D model training
# Generated specifically for run started around: 20250328_193633
...
LOG_FILE="training_branched_lstm_conv1d_20250328_193633.log" # Specific log file
REMOTE_DIR="/home/ec2-user/emotion_training"
PID_FILE="branched_lstm_conv1d_20250328_193633_pid.txt" # Specific PID file
MONITORING_INTERVAL=30

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING BRANCHED LSTM/Conv1D MODEL TRAINING (20250328_193633)    ${NC}"
echo -e "${BLUE}==================================================================${NC}"
