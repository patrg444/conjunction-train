...
# Generated specifically for run started around: 20250403_210945
...
REMOTE_MONITOR_HELPER="monitor_helper_precomputed_cnn_lstm_20250403_210945.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN} MONITORING PRECOMPUTED CNN AUDIO + LSTM MODEL TRAINING (20250403_210945) ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
