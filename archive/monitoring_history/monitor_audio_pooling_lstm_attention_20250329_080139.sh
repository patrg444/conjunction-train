...
# Generated specifically for run started around: 20250329_080139
...
REMOTE_MONITOR_HELPER="monitor_helper_audio_pooling_lstm_attention_20250329_080139.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING AUDIO POOLING LSTM + ATTENTION MODEL TRAINING (20250329_080139)    ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
