...
# Generated specifically for run started around: 20250405_072423
...
REMOTE_MONITOR_HELPER="monitor_helper_precomputed_cnn_lstm_20250405_072423.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN} MONITORING PRECOMPUTED CNN AUDIO + LSTM MODEL TRAINING (20250405_072423) ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
...
ssh -t -i "$KEY_FILE" "$USERNAME@$INSTANCE_IP" "cd $REMOTE_DIR && ./" # Corrected quoting for KEY_FILE
