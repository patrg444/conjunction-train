...
LOCAL_SCRIPT_PATH="scripts/train_lstm_conv1d_cross_attention_only.py" # Path to the NEW training script
REMOTE_SCRIPT_NAME="train_lstm_conv1d_cross_attention_only.py" # Name for the script on the EC2 instance
REMOTE_DIR="/home/ec2-user/emotion_training" # Directory on EC2 for training files
LOG_PREFIX="training_lstm_conv1d_cross_attention_only" # Prefix for log files
PID_PREFIX="lstm_conv1d_cross_attention_only" # Prefix for PID files
# --- End Configuration ---
...
echo -e "${BLUE}===================================================================${NC}"
echo -e "${GREEN}    DEPLOYING LSTM/CONV1D + CROSS-ATTENTION ONLY MODEL SCRIPT    ${NC}" # Updated Title
echo -e "${BLUE}===================================================================${NC}"
...
echo -e "${YELLOW}Transferring LSTM/Conv1D + Cross-Attention Only script ($LOCAL_SCRIPT_PATH) to AWS instance...${NC}" # Updated description
...
echo \"Starting LSTM/Conv1D + Cross-Attention Only model training...\" > $REMOTE_LOG_FILE # Updated description
...
# Monitoring script for LSTM/Conv1D + Cross-Attention Only model training # Updated description
...
echo -e \"\${BLUE}==================================================================\${NC}\"
echo -e \"\${GREEN}    MONITORING LSTM/CONV1D + CROSS-ATTENTION ONLY MODEL TRAINING (${TIMESTAMP})    \${NC}\" # Updated Title
echo -e \"\${BLUE}==================================================================\${NC}\"
