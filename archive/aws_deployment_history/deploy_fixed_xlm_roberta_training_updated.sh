...
echo -e "${BLUE}Deploying fixed XLM-RoBERTa training script to EC2 instance...${NC}"

# Upload the fixed Python script to EC2
echo -e "${BLUE}Uploading fixed script to EC2...${NC}"
scp -i "$SSH_KEY" fixed_train_xlm_roberta_script_updated.py ubuntu@$EC2_IP:/home/ubuntu/train_xlm_roberta_large_extended.py
