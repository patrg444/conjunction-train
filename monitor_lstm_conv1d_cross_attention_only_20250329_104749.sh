...
# Generated specifically for run started around: 20250329_104749
...
REMOTE_MONITOR_HELPER="monitor_helper_lstm_conv1d_cross_attention_only_20250329_104749.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING LSTM/CONV1D + CROSS-ATTENTION ONLY MODEL TRAINING (20250329_104749)    ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
