...
# Real-time Emotion Recognition with Synchronized Audio-Video
# This script launches the improved emotion recognition application with audio-video synchronization
...
echo -e "${BLUE}Real-time Emotion Recognition with Synchronized Audio-Video${NC}\n"
...
# Set parameters
CAMERA_INDEX=0
AUDIO_DEVICE=1  # MacBook Pro Microphone (confirmed with test_audio_video_sync.py)
...
echo -e "  - Microphone: ${GREEN}Device $AUDIO_DEVICE (MacBook Pro Microphone)${NC}"
