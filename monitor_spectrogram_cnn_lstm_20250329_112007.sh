...
# Generated specifically for run started around: 20250329_112007
...
REMOTE_MONITOR_HELPER="monitor_helper_spectrogram_cnn_lstm_20250329_112007.sh" # Name of the helper script on EC2

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING SPECTROGRAM CNN + LSTM MODEL TRAINING (20250329_112007)    ${NC}" # Updated Title
echo -e "${BLUE}==================================================================${NC}"
