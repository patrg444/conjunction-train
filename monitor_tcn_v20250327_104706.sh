...
# Generated specifically for model version: v20250327_104706
...
LOG_FILE="training_branched_regularization_sync_aug_tcn_large_fixed_v2_lr_increase_v20250327_104706.log" # Log file name passed from main script
REMOTE_DIR="/home/ec2-user/emotion_training"
PID_FILE="fixed_tcn_large_v20250327_104706_pid.txt" # Version specific PID file
MONITORING_INTERVAL=30

echo -e "${BLUE}==================================================================${NC}"
echo -e "${GREEN}    MONITORING TCN MODEL TRAINING (v20250327_104706)    ${NC}"
echo -e "${BLUE}==================================================================${NC}"
...
ssh -t -i "$KEY_FILE" "$USERNAME@$INSTANCE_IP" "
    ...
    BEST_ACC_FILE="best_val_accuracy_v20250327_104706.txt"
